            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.facebookUid.label" default="Facebook Uid" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "facebookUid")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.player.label" default="Player" /></td>
                            
                            <td valign="top" class="value"><g:link controller="player" action="show" id="${userInstance?.player?.id}">${userInstance?.player?.encodeAsHTML()}</g:link></td>
