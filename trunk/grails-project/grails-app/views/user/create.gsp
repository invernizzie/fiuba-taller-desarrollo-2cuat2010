                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="facebookUid"><g:message code="user.facebookUid.label" default="Facebook Uid" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'facebookUid', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="player"><g:message code="user.player.label" default="Player" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'player', 'errors')}">
                                    <g:select name="player.id" from="${com.teambook.model.Player.list()}" optionKey="id" value="${userInstance?.player?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
