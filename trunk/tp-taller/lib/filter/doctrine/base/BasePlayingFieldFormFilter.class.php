...
/**
 * PlayingField filter form base class.
 *
 * @package    tp-taller
 * @subpackage filter
 ...
 */
abstract class BasePlayingFieldFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('playing_field_filters[%s]');
