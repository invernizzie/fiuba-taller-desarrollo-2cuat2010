...
<%@ page import="com.teambook.model.Team" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="team.affiliations.label" default="Affiliations" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${teamInstance.affiliations}" var="a">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="team.discipline.label" default="Discipline" /></td>
                            
                            <td valign="top" class="value"><g:link controller="discipline" action="show" id="${teamInstance?.discipline?.id}">${teamInstance?.discipline?.encodeAsHTML()}</g:link></td>
